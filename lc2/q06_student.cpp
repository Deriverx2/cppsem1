...
public:
void get_marks(float a, float b, float c) { sub1 = a; sub2 = b; sub3 = c; }
void show_marks() { std::cout << "Marks for sub1: " << sub1 << std::endl<< "Marks for sub2: "
<< sub2 << std::endl<< "Marks for sub3: " << sub3 << std::endl; }
};
