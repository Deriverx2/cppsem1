...
public:
IBase(const std::string& value1, const std::string& value2, const std::string& value3):
Base1(value1),
Base2(value2){
    ibase_value=value3;
}
...
public:
Derived(const std::string& value1, const std::string& value2, const std::string& value3, const
std::string& value4):
IBase(value1, value2, value3){
